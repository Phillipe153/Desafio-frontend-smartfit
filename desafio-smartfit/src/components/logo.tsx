export function Logo() {
    return(
        <svg version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://  www.w3.org/1999/xlink" x="0px" y="0px"
            viewBox="0 0 146 54" xmlSpace="preserve">

            <path className="st0" style={{fill: '#FCB823'}} d="M95,38.5V10.7c0-9.5,9.9-11.5,17-8.8v5.3c-4.9-2-10.4-1.5-10.4,4.6h7.9v5.3h-7.9v21.3L95,38.5z"/>
            <path className="st0"  style={{fill: '#FCB823'}}d="M126.5,7.7h4.9l1,4.1h6.1v5.3h-5.4v12.3c0,2.5,1.1,3.7,3.2,3.7h3.4v5.3h-6.6c-4.4,0-6.7-2.4-6.7-7.1V7.7z"/>
            <rect x="114.7" y="11.8" className="st0" style={{fill: '#FCB823'}}width="6.7" height="26.6"/>
            <rect x="114.7" y="2.2" className="st0" style={{fill: '#FCB823'}} width="6.7" height="5.5"/>
            <path className="st0" style={{fill: '#FCB823'}} d="M145.4,38.4c-5.9,9.3-16.2,15.4-28,15.4c-11.8,0-22.1-6.1-28-15.4c6.9,6.4,16.9,10.3,28,10.3
                C128.5,48.8,138.5,44.8,145.4,38.4"/>
            <path className="st1" style={{fill: '#FFF'}}  d="M0.8,32.3v-3.6c1.9,0.8,4.2,1.2,6.7,1.2c1.9,0,2.8-0.6,2.8-1.8c0-1.1-0.6-1.7-1.9-1.7H5.3
